        ...
        <div onClick={e => e.stopPropagation()} className=" bg-white  absolute bottom-0 w-full rounded-t-3xl px-10 transition-all delay-200 shadow-2xl">
          <div>
            ...
            <div className="text-gray-700 md:flex md:justify-between">
              <div className=" border-b-2 border-gray-300 py-2 md:py-8 ">
              ...
              <div className=" border-b-2 border-gray-300 py-2 md:py-8">
                ...
                <ul className="grid grid-cols-3 gap-y-2 md:flex flex-col">
                  <li><a className="capitalize" href="#">spacee.org:<br /> </a></li>
                  <li><a className="capitalize" href="#">Combating discrimination</a></li>

                </ul>
              </div>
              <div className=" border-b-2 border-gray-300 py-2 md:py-6 ">
              ...
              <div className="  pb-20 md:pt-6 pt-2">
