...
export default function () {
    ...
    return (
        <>
            <footer>
                <div className=" fixed bottom-0 flex justify-between px-8 text-sm py-3 shadow-inner  bg-white w-full">
                    <ul className="grid grid-cols-3">
                        <li className="list-disc">&copy;{new Date().getFullYear()} spacee,Inc</li>
                        <li className="list-disc ml-2">terms</li>
                        <li className="list-disc ">sitemap</li>
                        <li className="list-disc">privacy</li>
                        <li className="list-disc">destinations</li>
                        <li className="list-disc">your privacy choices</li>
